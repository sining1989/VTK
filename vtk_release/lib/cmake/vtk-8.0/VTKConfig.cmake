...
set(_vtk_installed_prefix "D:/zsz/vtk/vtk_debug/lib/cmake/vtk-8.0")
...
if (_vtk_installed_prefix_full STREQUAL _vtk_requested_prefix_full)
  set(VTK_INSTALL_PREFIX "D:/zsz/vtk/vtk_debug")
else ()
...
if (__vtk_install_tree)
  if (WIN32)
    set (VTK_RUNTIME_DIRS "D:/zsz/vtk/vtk_debug/bin")
  else ()
    set (VTK_RUNTIME_DIRS "D:/zsz/vtk/vtk_debug/lib")
  endif ()
else()
  if (WIN32)
    set (VTK_RUNTIME_DIRS "D:/zsz/vtk/vtk_build/bin")
  else ()
    set (VTK_RUNTIME_DIRS "D:/zsz/vtk/vtk_build/lib")
  endif ()
endif()
